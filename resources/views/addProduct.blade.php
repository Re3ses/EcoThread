                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('product_name') is-invalid @enderror" required
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('product_price') is-invalid @enderror" required
                                    id="product_price" name="product_price" type="text" placeholder="Enter product price"
                        ...
                        <div class="row">
                            <div class="col-sm-6 ">
                                <img id="preview-image-before-upload" src="{{ asset('/img/Upload Image.png') }}"
                                    alt="preview image" style="height: 10vw; width: 10vw; object-fit: cover;"
                                    class=" mb-2">
                                <input class=" form-control @error('img') is-invalid @enderror " type="file"
                                    name="img" value="{{ old('img') }}" id="img">
                                @error('img')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
